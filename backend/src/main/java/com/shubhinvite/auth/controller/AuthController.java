package com.shubhinvite.auth.controller;
...
import com.shubhinvite.auth.service.AuthService;
...
@Tag(name = "Authentication", description = "Register and login; both are public endpoints")
