...
/** Reads the Bearer token (if any), and populates the SecurityContext from its claims. */
@Component
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        if (header != null && header.startsWith(BEARER_PREFIX) && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            try {
                ...
                CurrentUser currentUser = new CurrentUser(jwtService.extractUserId(claims), jwtService.extractEmail(claims));
